...
int main ()
{
	...
	string copy = strncpy(str1,str2,3); //strncpy (1st string, 2nd string, no. of characters to be copied from 2rd to 1st string)
	cout <<copy;
	...
	//use to compare the characters in the strings 
